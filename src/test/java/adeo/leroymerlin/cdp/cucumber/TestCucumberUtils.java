...
public class TestCucumberUtils {
  ...
  List<Map<Object, String>> rawTablewithId = Arrays.asList(
    Map.of("namedIdentifier", "1", "comment", "This is my first comment")
  );
  List<Map<Object, String>> rawTablewithWrongAttribute = Arrays.asList(
    Map.of("comment", "This is my first comment", "commentary", "Superbe")
  );
  List<Map<Object, String>> rawTableWith2Rows = Arrays.asList(
  ...
  List<Map<Object, String>> rawTableWith2RowsAllTypes = Arrays.asList(
  ...
  List<Map<Object, String>> rawTableWithWrongValue = Arrays.asList(
    Map.of("comment", "This is my first comment", "longDistance", "1253456"),
